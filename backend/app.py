...
app = FastAPI(title="VerifiableRAG", version="2.0.0")
        ...
        if len(doc_ids) <= 1:
            ...
            if not evidence:
                ...
                if ABSTENTION_MESSAGE in answer:
                    result = {"answer": answer, "abstained": True, "claims": [], "sources": evidence, "rounds": 0, "hallucination_risk_score": 100}
                else:
                    ...
                    result = {
                        ...
                        "sources": evidence,
                        "rounds": 0,
                        "hallucination_risk_score": compute_hallucination_risk_score(verdicts, not bool(supported)),
                    }
    except Exception as e:
        raise HTTPException(
            status_code=503,
